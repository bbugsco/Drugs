...
public class SingleInputTimedRecipeBuilder implements RecipeBuilder {
    ...
    protected SingleInputTimedRecipeBuilder(final Ingredient ingredient, final ItemLike result, int time, SingleInputTimedRecipe.Factory<? extends SingleInputTimedRecipe> factory) {
